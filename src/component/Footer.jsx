...
const Footer = () => {
  return (
    <footer className="footer footer-center p-10 bg-[#2D231D] text-white rounded-t-[50px] mt-20">
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a className="cursor-pointer hover:text-[#B68C59] transition-colors">
      ...
      <aside>
        <p className="text-gray-400">Copyright © 2026 - All right reserved by <strong>Keen Keeper</strong> Ltd</p>
      </aside>
    </footer>
  );
};
