      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          ...
          <div className="flex items-center gap-4">
            <span className="font-bold text-[#2D231D]">Sort By:</span>
            <select 
              className="select select-bordered w-full max-w-xs rounded-full border-[#B68C59] focus:outline-none"
          ...
          {animals.map((pet) => (
            <div key={pet.id} className="card bg-white shadow-sm hover:shadow-2xl transition-all duration-300 rounded-[40px] overflow-hidden border border-gray-100 group">
              ...
              <figure className="relative h-72 w-full overflow-hidden">
                ...
                />
                <div className="absolute top-5 right-5 bg-white/90 backdrop-blur-md px-4 py-1 rounded-full text-[#B68C59] font-bold shadow-sm">
              ...
              <div className="card-body p-8">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="badge bg-[#B68C59]/10 text-[#B68C59] border-none font-bold p-3">
                    {pet.category}
                  </div>
                </div>
                ...
                <div className="card-actions mt-8">
                  <Link 
                    href={`/animals/${pet.id}`} 
                    className="btn bg-[#B68C59] hover:bg-[#2D231D] text-white w-full rounded-full border-none transition-colors duration-300"
                  >
                    View Full Details
                  </Link>
                </div>
